# Spec: hardcoded-shape-rule

## Purpose

Правило Detekt `HardcodedShape` обнаруживает прямое использование хардкодированных форм и радиусов в Compose-коде вместо токенов design system.
